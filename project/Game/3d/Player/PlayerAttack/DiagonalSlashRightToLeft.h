...
class DiagonalSlashRightToLeft :
	public IPlayerAttack{
public:
	//===================================================================*/
	//                   public member functions
	//===================================================================*/
	DiagonalSlashRightToLeft(const std::string& attackName);
	~DiagonalSlashRightToLeft() override = default;
	...
	std::string GetType() const override{
		return "DiagonalSlashRightToLeft";
	}
...
private:
	...
	Vector3 targetRotate_ = {2.1f, 0.48f, -0.59f}; // 目標回転
